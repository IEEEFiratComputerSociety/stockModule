 ...
 * @author CAN
 */
public class ARAYUZSATIS extends javax.swing.JFrame {
    ...
    private void jLabel_SATISMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_SATISMouseClicked
        SATIS_SATIŞ_ELEMANI a = new SATIS_SATIŞ_ELEMANI();
        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ARAYUZSATIS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ARAYUZSATIS().setVisible(true);
            }
        });
    }
